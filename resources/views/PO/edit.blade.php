    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        <div class="row align-items-center g-lg-5 py-5">
            <div class="col-lg-7 text-center text-lg-start">
                <h1 class="display-4 fw-bold lh-1 text-body-emphasis mb-3">Редактирование стеганопрограммы</h1>
                <p class="col-lg-10 fs-4">В данной форме необходимо выбрать изменяемую стеганографическую программу и указать новые данные. После заполнения нажмите кнопку «Изменить».</p>
            </div>
            <div class="col-md-10 mx-auto col-lg-5">
                <form class="p-4 p-md-5 border rounded-3 bg-body-tertiary" method="post" action="/PO/edited">
                    @csrf
                    <div class="form-floating mb-3">
                        <select name="st_name_upd" id="st_name_upd" class="form-control">
                            <option value="1">Clotho</option>
                        </select>
                    </div>
                    <div class="form-floating mb-3">
